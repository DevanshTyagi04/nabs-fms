  ...
  return (
    <ProtectedRoute>
      <RoleGuard roles={['CUSTOMER']}>
        <MobileLayout title="My Billing Invoices" activeTab={activeTab} onTabChange={handleTabChange}>
              ...
              invoices.map((inv) => (
                <Card key={inv.id}>
                  <CardHeader style={styles.cardHeader}>
                    ...
                    <Text style={{ fontSize: 11, color: colors.mutedForeground }}>Vendor: {inv.vendorName}</Text>
                  </CardHeader>
                  ...
                  <CardContent style={{ gap: 12 }}>
                    ...
                    {/* Phase 10 Payment Action Placeholder */}
                    {inv.amountDue > 0 && (
                      <Button variant="primary" onPress={() => router.push('/payments' as any)}>
                        Pay ${inv.amountDue.toFixed(2)} Online
                      </Button>
                    )}
                  </CardContent>
                </Card>
